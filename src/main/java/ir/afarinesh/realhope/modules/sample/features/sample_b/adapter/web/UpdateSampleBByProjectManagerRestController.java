...
@RestController
@RequestMapping("/app/admin/project-manager/sample-b/update-sample-b-by-project-manager")
public class UpdateSampleBByProjectManagerRestController{

	final UpdateSampleBByProjectManagerUseCase useCase; 

	public UpdateSampleBByProjectManagerRestController(UpdateSampleBByProjectManagerUseCase useCase) {
