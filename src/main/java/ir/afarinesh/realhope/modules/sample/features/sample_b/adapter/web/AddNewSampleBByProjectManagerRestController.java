...
@RestController
@RequestMapping("/app/admin/project-manager/sample-b/add-new-sample-b-by-project-manager")
public class AddNewSampleBByProjectManagerRestController{

	final AddNewSampleBByProjectManagerUseCase useCase; 

	public AddNewSampleBByProjectManagerRestController(AddNewSampleBByProjectManagerUseCase useCase) {
