...
public class AddNewUseCaseByProjectManagerService {
    ...
    public AddNewUseCaseByProjectManagerService(CrudCodeGenerationSpringJpaRepository crudCodeGenerationSpringJpaRepository, SoftwareFeatureSpringJpaRepository softwareFeatureSpringJpaRepository, SoftwareRoleSpringJpaRepository softwareRoleSpringJpaRepository, SoftwareApplicationPanelSpringJpaRepository softwareApplicationPanelSpringJpaRepository, DataEntitySpringJpaRepository dataEntitySpringJpaRepository, UseCaseSpringJpaRepository useCaseSpringJpaRepository){
