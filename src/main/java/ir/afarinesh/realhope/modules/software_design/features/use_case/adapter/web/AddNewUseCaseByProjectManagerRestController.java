...
@RestController
@RequestMapping("/app/admin/project-manager/use-case/add-new-use-case-by-project-manager")
public class AddNewUseCaseByProjectManagerRestController{

	final AddNewUseCaseByProjectManagerUseCase useCase; 

	public AddNewUseCaseByProjectManagerRestController(AddNewUseCaseByProjectManagerUseCase useCase) {
