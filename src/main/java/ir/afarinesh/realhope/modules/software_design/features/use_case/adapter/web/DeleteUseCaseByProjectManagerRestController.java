...
@RestController
@RequestMapping("/app/admin/project-manager/use-case/delete-use-case-by-project-manager")
public class DeleteUseCaseByProjectManagerRestController{

	final DeleteUseCaseByProjectManagerUseCase useCase; 

	public DeleteUseCaseByProjectManagerRestController(DeleteUseCaseByProjectManagerUseCase useCase) {
