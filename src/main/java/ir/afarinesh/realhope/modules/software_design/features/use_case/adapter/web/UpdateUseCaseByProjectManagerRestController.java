...
@RestController
@RequestMapping("/app/admin/project-manager/use-case/update-use-case-by-project-manager")
public class UpdateUseCaseByProjectManagerRestController{

	final UpdateUseCaseByProjectManagerUseCase useCase; 

	public UpdateUseCaseByProjectManagerRestController(UpdateUseCaseByProjectManagerUseCase useCase) {
