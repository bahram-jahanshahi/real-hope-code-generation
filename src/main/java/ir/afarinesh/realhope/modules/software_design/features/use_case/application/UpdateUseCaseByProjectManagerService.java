...
public class UpdateUseCaseByProjectManagerService {
    ...
    public UpdateUseCaseByProjectManagerService(SoftwareApplicationPanelSpringJpaRepository softwareApplicationPanelSpringJpaRepository, UseCaseSpringJpaRepository useCaseSpringJpaRepository, SoftwareRoleSpringJpaRepository softwareRoleSpringJpaRepository, DataEntitySpringJpaRepository dataEntitySpringJpaRepository, SoftwareFeatureSpringJpaRepository softwareFeatureSpringJpaRepository){
